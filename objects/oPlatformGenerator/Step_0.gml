...
if (global.created == false)
{
	for (var i = 0; i < 4; i++)
	{
		...
		if (i == 3) { instance_create_layer(global.boxOriginX - (global.borderWidth / 2), global.boxOriginY + (global.borderHeight / 2), "ExtrasObjects", oWaveTrigger); global.created = true; }
	}
}
