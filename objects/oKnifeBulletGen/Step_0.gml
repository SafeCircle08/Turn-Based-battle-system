...
if (global.created == false)
{
	...
	if (global.createTimer == 0)
	{
		...
		instance_create_layer(_tubesCoord[0][_actualBullet], _tubesCoord[1][_actualBullet], LAYER_BULLETS, global.bulletKind[3][0][_actualBullet]);
	...
	if (global.bulletsCreated == 4) 
	{
		...
		instance_create_layer(160, 53, LAYER_BULLETS, oBulletSteamDown);
		instance_create_layer(160, 53, LAYER_BULLETS, oExclamationMark);
